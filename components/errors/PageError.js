        ...
        <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
          <div className="max-w-md">
            ...
            <Link href="/dashboard">
              <a
                href=""
                className="flex bg-blue-500 rounded-full font-bold text-white hover:text-white px-3 py-2 transition duration-300 ease-in-out hover:bg-blue-600  mt-3 justify-center items-center"
              >
                Home
                <svg
